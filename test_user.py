...
class TestModels(unittest.TestCase):
    ...
    def test_correct_login(self):
        ...
        """
        tester = app.test_client(self)
        response = tester.post('/api/login', data='{"username":"mama", "password": "123456"}', follow_redirects=True)
    ...
    #     """
    #     tester = app.test_client(self)
    #     response = tester.post('/api/editUser', data='{"firstname": "lionel", "lastname": "messi", "username":"lionel", "email":"lionel@gmail.com", "password": "1234567890"}', follow_redirects=True)
    #     self.assertIn(b"true", response.data)
